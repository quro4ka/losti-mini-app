...
import {Icon24Fire, Icon56UsersOutline} from '@vkontakte/icons'
...
import {Icon28NewsfeedOutline, Icon28ServicesOutline, Icon28HappyFaceOutline} from '@vkontakte/icons'
import Navigation from './panels/Navigation'
import {MyCalendar} from './components/MyCalendar/MyCalendar'
import {MyPopup} from './components/MyPopup/MyPopup'
import MyButtonRasp from "./components/Button/MyButtonRasp";
// import { Icon28HappyFaceOutline } from '@vkontakte/icons';
                                                            ...
                                                            <Card>
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div
                                                                            style={{marginBottom: '20px'}}>Место: {event.place}</div>
                                                                        <Button
                                                                            onClick={() => openPopup(event)}>Open</Button>
                                                                    </div>
                                                                    {event.hot && (
                                                                        <Icon24Fire
                                                                            style={{
                                                ...
                                                <>
                                                  ...
                                                  {dayIndex === 2 &&
                                                      <Placeholder
                                                          ...
                                                          icon={<Icon32MasksOutline style={{width: 84,height:84}} />}
                                                      >
